	...
	render() {
		...
		switch ( icon ) {
			...
			case 'games':
				...
				break;
			case 'google':
				path = 'M10.152 11.52V8.544h7.488a6.964 6.964 0 0 1 .2 1.64c0 4.568-3.064 7.816-7.68 7.816a8 8 0 0 1 0-16 7.658 7.658 0 0 1 5.352 2.088L13.24 6.3a4.4 4.4 0 0 0-3.08-1.184 4.9 4.9 0 0 0 0 9.792 4.145 4.145 0 0 0 4.4-3.376h-4.408z" fillRule="evenodd"/></g></g></g><';
				break;
			case 'googleplus':
