	...
	render() {
		...
		switch ( icon ) {
			...
			case 'bank':
				...
				break;
			case 'beer-icon':
				path = 'M14.444 10.273a2.588 2.588 0 0 1-.62-1 3.485 3.485 0 0 1-2.034-1 3.537 3.537 0 0 1-.995-2.05 2.566 2.566 0 0 1-1-.627 2.6 2.6 0 0 1-.713-1.375l-.915.923-.744-.75a1.722 1.722 0 0 0-2.45 0l-2.465 2.48a1.758 1.758 0 0 0 0 2.47l.744.752-.613.618a1.758 1.758 0 0 0 0 2.472l4.265 4.3a1.723 1.723 0 0 0 2.452 0l6.442-6.5a2.568 2.568 0 0 1-1.356-.712zM4.162 9.16l-.516-.522a.753.753 0 0 1 0-1.06l2.03-2.046a.738.738 0 0 1 1.05 0l.517.52zm4.31-2.182a.646.646 0 0 1 .918 0 .66.66 0 0 1 0 .927L5.082 12.25a.646.646 0 0 1-.92 0 .66.66 0 0 1 0-.927zm1.837 1.854a.646.646 0 0 1 .918 0 .66.66 0 0 1 0 .927L6.92 14.1a.646.646 0 0 1-.92 0 .66.66 0 0 1 0-.928zm1.837 1.854a.646.646 0 0 1 .92 0 .66.66 0 0 1 0 .927l-4.31 4.345a.646.646 0 0 1-.918 0 .66.66 0 0 1 0-.927zm4.036-6.852a2.713 2.713 0 0 1 .582 2.93 1.715 1.715 0 0 1 .73.43 1.75 1.75 0 0 1 0 2.46 1.715 1.715 0 0 1-2.44 0 1.742 1.742 0 0 1-.5-1.243 2.646 2.646 0 0 1-2.15-.764 2.7 2.7 0 0 1-.757-2.17 1.71 1.71 0 0 1-1.235-.507 1.75 1.75 0 0 1 0-2.46 1.71 1.71 0 0 1 2.866.738 2.656 2.656 0 0 1 2.906.586"/></g><';
				break;
			case 'beer':
			...
			case 'games':
				...
				break;
			case 'google':
				path = 'M10.152 11.52V8.544h7.488a6.964 6.964 0 0 1 .2 1.64c0 4.568-3.064 7.816-7.68 7.816a8 8 0 0 1 0-16 7.658 7.658 0 0 1 5.352 2.088L13.24 6.3a4.4 4.4 0 0 0-3.08-1.184 4.9 4.9 0 0 0 0 9.792 4.145 4.145 0 0 0 4.4-3.376h-4.408z" fillRule="evenodd"/></g><';
				break;
			case 'googleplus':
				path = 'M17.6 8.5h-7.5v3h4.4c-.4 2.1-2.3 3.5-4.4 3.4-2.6-.1-4.6-2.1-4.7-4.7-.1-2.7 2-5 4.7-5.1 1.1 0 2.2.4 3.1 1.2l2.3-2.2C14.1 2.7 12.1 2 10.2 2c-4.4 0-8 3.6-8 8s3.6 8 8 8c4.6 0 7.7-3.2 7.7-7.8-.1-.6-.1-1.1-.3-1.7z';
				break;
			case 'grid-view':
			...
			case 'paperclip':
				...
				break;
			case 'pdf':
				path = 'M5.8 14H5v1h.8c.3 0 .5-.2.5-.5s-.2-.5-.5-.5zM11 2H3v16h13V7l-5-5zM7.2 14.6c0 .8-.6 1.4-1.4 1.4H5v1H4v-4h1.8c.8 0 1.4.6 1.4 1.4v.2zm4.1.5c0 1-.8 1.9-1.9 1.9H8v-4h1.4c1 0 1.9.8 1.9 1.9v.2zM15 14h-2v1h1.5v1H13v1h-1v-4h3v1zm0-2H4V3h7v4h4v5zm-5.6 2H9v2h.4c.6 0 1-.4 1-1s-.5-1-1-1z';
				break;
			case 'performance':
			...
			case 'tickets':
				...
				break;
			case 'tide':
				path = 'M17 7.2V3H3v7.1A19.974 19.974 0 0 0 10 7v3a21.725 21.725 0 0 1-7 2.8V17h14V9.9a23.417 23.417 0 0 0-7 3V10a20.825 20.825 0 0 1 7-2.8z';
				break;
			case 'translation':
			...
			case 'trash':
				...
				break;
			case 'twitch':
				path = 'M2.7 2L2 4.6v11.8h3.2V18H7l1.8-1.6h2.9l5.7-5.2V2H2.7zM16 10.5l-2.5 2.3h-4l-2.2 2v-2H4.2V3.3H16v7.2zm-2.5-4.6h-1.4v3.9h1.4V5.9zm-4 0H8.1v3.9h1.4V5.9z';
				break;
			case 'twitter-alt':
