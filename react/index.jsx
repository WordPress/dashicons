	...
	render() {
		...
		switch ( icon ) {
			...
			case 'businessman':
				...
				break;
			case 'businessperson':
				path = 'M13.2 10L11 13l-1-1.4L9 13l-2.2-3C3 11 3 13 3 16.9c0 0 3 1.1 6.4 1.1h1.2c3.4-.1 6.4-1.1 6.4-1.1 0-3.9 0-5.9-3.8-6.9zm-3.2.7L8.4 10l1.6 1.6 1.6-1.6-1.6.7zM7.3 6.063l-.03-.19c-.04-.37-.05-.73-.03-1.08.02-.36.1-.71.25-1.04.14-.32.31-.61.52-.86.21-.25.49-.46.83-.6.34-.15.72-.23 1.13-.23.69 0 1.26.2 1.71.59s.76.87.91 1.44.18 1.16.09 1.78l-.03.19c-.01.09-.05.25-.11.48-.05.24-.12.47-.2.69-.08.21-.19.45-.34.72-.14.27-.3.49-.47.69-.18.19-.4.34-.67.48-.27.13-.55.19-.86.19s-.59-.06-.87-.19c-.26-.13-.49-.29-.67-.5-.18-.2-.34-.42-.49-.66-.15-.25-.26-.49-.34-.73-.09-.25-.16-.47-.21-.67-.06-.21-.1-.37-.12-.5z';
				break;
			case 'businesswoman':
				path = 'M8 4.7s1.1 1.2 4.3 1.5c0 0-.3 1.8-1 2.4 0 0-.2.2.4.4s2 .7 3.1-.1c0 0 .1-.1 0-.3 0 0-1.7-.9-1.7-3 0 0 .2-3.4-2.6-3.6 0 0-2.4-.4-3.2 1.5-.4 1.2-.2 2.1-.5 3.1-.2.6-.6 1.3-1.2 1.8 0 0-.5.2-.4.5s1.4.6 2.7.2c0 0 .8-.2.9-.5-.8-1-1.5-2-.8-3.9zM7.4 10c-1.2 0-2.5.2-3.4 1-.8.7-1 1.9-1 3.1v2.8s3.4 1.2 7 1.1c3.6.1 7-1.1 7-1.1v-2.8c0-1.1-.2-2.3-1-3.1-.9-.8-2.2-.9-3.4-1l1 2.1-3.6 3.7 2.3-5.8-2.2 1-2.4-1 2.3 5.8-3.6-3.6 1-2.2z';
				break;
			case 'button':
