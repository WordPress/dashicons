	...
	render() {
		...
		switch ( icon ) {
			...
			case 'phone':
				...
				break;
			case 'pinterest':
				path = 'M8 1.07C4.172 1.07 1.07 4.17 1.07 8c0 2.938 1.827 5.444 4.405 6.453-.06-.547-.116-1.39.025-1.988.125-.54.813-3.444.813-3.444s-.206-.415-.206-1.027c0-.963.56-1.684 1.253-1.684.59 0 .878.443.878.974 0 .594-.378 1.484-.575 2.306-.166.69.344 1.253 1.025 1.253 1.23 0 2.178-1.3 2.178-3.175 0-1.66-1.194-2.82-2.894-2.82C6 4.85 4.844 6.33 4.844 7.86c0 .597.228 1.234.516 1.58.056.07.066.13.047.2-.053.22-.17.692-.194.788-.03.128-.1.153-.23.094-.867-.403-1.407-1.67-1.407-2.684 0-2.188 1.587-4.194 4.578-4.194 2.403 0 4.272 1.712 4.272 4.003 0 2.388-1.506 4.313-3.597 4.313-.704 0-1.363-.366-1.59-.797l-.43 1.648c-.156.603-.578 1.356-.862 1.816.65.2 1.337.31 2.053.31 3.83 0 6.932-3.104 6.932-6.932 0-3.83-3.103-6.934-6.93-6.934z';
				break;
			case 'pinterest2':
				path = 'M8 0C3.588 0 0 3.587 0 8s3.587 8 8 8 8-3.588 8-8-3.588-8-8-8zm0 14.93c-.716 0-1.403-.108-2.053-.308.28-.46.706-1.216.862-1.816.083-.325.43-1.647.43-1.647.225.43.888.796 1.587.796 2.09 0 3.597-1.922 3.597-4.313 0-2.29-1.87-4.003-4.272-4.003-2.99 0-4.578 2.01-4.578 4.194 0 1.016.54 2.28 1.406 2.684.13.063.2.034.23-.094.023-.097.142-.566.195-.787.016-.07.01-.13-.047-.2-.287-.347-.516-.988-.516-1.58 0-1.53 1.156-3.01 3.128-3.01 1.703 0 2.894 1.16 2.894 2.82 0 1.874-.947 3.174-2.178 3.174-.68 0-1.19-.562-1.025-1.252.198-.825.576-1.713.576-2.306 0-.53-.284-.975-.878-.975-.697 0-1.253.72-1.253 1.684 0 .613.206 1.03.206 1.03s-.687 2.902-.812 3.443c-.14.6-.084 1.44-.025 1.988C2.895 13.446 1.067 10.94 1.067 8c0-3.827 3.103-6.93 6.93-6.93S14.93 4.173 14.93 8c0 3.83-3.104 6.932-6.932 6.932z';
				break;
			case 'playlist-audio':
