	...
	render() {
		...
		switch ( icon ) {
			...
			case 'align-wide':
				...
				break;
			case 'amazon':
				path = 'M15.19 13c-.224-.287-1.48-.137-2.046-.07-.172.02-.197-.127-.044-.237 1.003-.703 2.647-.5 2.838-.266.194.238-.05 1.884-.99 2.672-.145.12-.282.055-.22-.104.216-.528.688-1.71.463-1.997zM11.053 11.838l.003.003c.387-.34 1.084-.95 1.478-1.277.156-.125.128-.334.006-.51-.353-.487-.728-.883-.728-1.783v-3c0-1.272.088-2.438-.847-3.313C10.227 1.25 9.002 1 8.065 1c-1.83 0-3.875.685-4.303 2.948-.047.24.13.37.287.403l1.865.204c.175-.01.3-.18.334-.356.158-.778.812-1.156 1.546-1.156.397 0 .847.144 1.08.5.27.397.235.938.235 1.397v.25c-1.115.124-2.574.205-3.618.665C4.286 6.377 3.44 7.44 3.44 9.002c0 2 1.258 3 2.88 3 1.37 0 2.116-.322 3.172-1.403.35.505.463.752 1.103 1.283.147.078.328.072.456-.044zm-1.94-4.694c0 .75.02 1.375-.36 2.04-.305.545-.79.876-1.33.876-.737 0-1.17-.563-1.17-1.394 0-1.64 1.473-1.938 2.864-1.938v.416z';
				break;
			case 'analytics':
			...
			case 'welcome-write-blog':
				...
				break;
			case 'whatsapp':
				path = 'M13.64 2.325C12.145.825 10.154 0 8.033 0 3.662 0 .107 3.556.107 7.928c0 1.397.366 2.763 1.06 3.963L.04 16l4.204-1.103c1.16.63 2.463.966 3.787.966h.004c4.37 0 7.928-3.556 7.928-7.928 0-2.12-.825-4.11-2.322-5.61zm-5.606 12.2c-1.184 0-2.344-.32-3.356-.92l-.24-.143-2.495.653.666-2.43-.157-.25c-.663-1.048-1.01-2.26-1.01-3.507 0-3.634 2.957-6.59 6.595-6.59 1.76 0 3.416.687 4.66 1.93 1.243 1.247 1.927 2.9 1.927 4.662-.003 3.637-2.96 6.594-6.59 6.594zm3.613-4.937c-.197-.1-1.172-.578-1.353-.644s-.313-.1-.447.1c-.13.197-.512.644-.628.778-.117.13-.232.15-.43.05s-.837-.31-1.593-.984c-.588-.525-.987-1.175-1.103-1.372s-.013-.306.088-.403c.09-.088.197-.23.297-.347s.13-.197.196-.33c.066-.132.034-.248-.016-.348s-.447-1.075-.61-1.472c-.158-.388-.324-.334-.446-.34-.116-.007-.247-.007-.378-.007s-.347.05-.528.246c-.18.197-.694.678-.694 1.653s.71 1.915.81 2.05c.1.13 1.396 2.133 3.383 2.99.472.203.84.325 1.128.42.475.15.906.127 1.247.077.38-.056 1.172-.478 1.338-.94s.166-.86.116-.942c-.047-.088-.178-.137-.378-.238z';
				break;
			case 'wordpress-alt':
