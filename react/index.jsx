	...
	render() {
		...
		switch ( icon ) {
			...
			case 'tickets':
				...
				break;
			case 'tide':
				path = 'M0 0h20v5.988a30.236 30.236 0 0 0-9.974 3.984v4.165q.556-.32 1.105-.64A27.857 27.857 0 0 1 20 9.81V20H0v-6.1a29.924 29.924 0 0 0 10.026-3.958V5.777q-.468.27-.93.54A27.934 27.934 0 0 1 0 10.08z';
				break;
			case 'translation':
