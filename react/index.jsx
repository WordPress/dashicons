	...
	render() {
		...
		switch ( icon ) {
			...
			case 'clock':
				...
				break;
			case 'cloud-saved':
				path = 'M14.8 10c.1-.3.2-.6.2-1 0-2.2-1.8-4-4-4-1.5 0-2.9.9-3.5 2.2-.3-.1-.7-.2-1-.2C5.1 7 4 8.1 4 9.5c0 .2 0 .4.1.5-1.8.3-3.1 1.7-3.1 3.5C1 15.4 2.6 17 4.5 17h10c1.9 0 3.5-1.6 3.5-3.5 0-1.8-1.4-3.3-3.2-3.5zm-6.3 5.9l-3.2-3.2 1.4-1.4 1.8 1.8 3.8-3.8 1.4 1.4-5.2 5.2z';
				break;
			case 'cloud-upload':
				path = 'M14.8 10c.1-.3.2-.6.2-1 0-2.2-1.8-4-4-4-1.5 0-2.9.9-3.5 2.2-.3-.1-.7-.2-1-.2C5.1 7 4 8.1 4 9.5c0 .2 0 .4.1.5-1.8.3-3.1 1.7-3.1 3.5C1 15.4 2.6 17 4.5 17H8v-3H5l4.5-4.5L14 14h-3v3h3.5c1.9 0 3.5-1.6 3.5-3.5 0-1.8-1.4-3.3-3.2-3.5z';
				break;
			case 'cloud':
