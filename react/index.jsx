	...
	render() {
		...
		switch ( icon ) {
			...
			case 'pressthis':
				...
				break;
			case 'printer':
				path = 'M4 1h8v2H4V1zM15 4H1c-.55 0-1 .45-1 1v5c0 .55.45 1 1 1h3v4h8v-4h3c.55 0 1-.45 1-1V5c0-.55-.45-1-1-1zM2 7c-.552 0-1-.448-1-1s.448-1 1-1 1 .448 1 1-.448 1-1 1zm9 7H5V9h6v5z';
				break;
			case 'products':
