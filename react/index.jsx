	...
	render() {
		...
		switch ( icon ) {
			...
			case 'backup':
				...
				break;
			case 'block-default':
				path = 'M15 6V4h-3v2H8V4H5v2c-1.1 0-2 .9-2 2v8h14V8c0-1.1-.9-2-2-2z';
				break;
			case 'book-alt':
			...
			case 'email':
				...
				break;
			case 'embed-audio':
				path = 'M16 4H4c-1.1 0-2 .9-2 2v7c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-8 8v.3c-.2 1.1-1.2 1.8-2.3 1.7-1.1-.2-1.8-1.2-1.7-2.3.2-1.1 1.2-1.8 2.3-1.7.3 0 .5.1.7.3V5h4v2H8v5zm5.4 1.6l-.7.7-2.4-2.3 2.4-2.4.7.7-1.7 1.7 1.7 1.6zm1 .8l-.7-.7 1.6-1.6-1.6-1.6.7-.7 2.4 2.4-2.4 2.2z';
				break;
			case 'embed-generic':
				path = 'M16 4H4c-1.1 0-2 .9-2 2v7c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-8.1 7.1l-.7.7-2.4-2.3 2.4-2.4.7.7-1.7 1.7 1.7 1.6zm1.6 2l-1-.3 2-7 1 .3-2 7zm3.4-1.2l-.7-.7 1.6-1.6L12.2 8l.7-.7 2.4 2.4-2.4 2.2z';
				break;
			case 'embed-photo':
				path = 'M16 4H4c-1.1 0-2 .9-2 2v7c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zM7.5 9.9l-2 4.1H4c-.6 0-1-.4-1-1V6c0-.6.4-1 1-1h7c.6 0 1 .4 1 1v3l-.5-1.1c-.2-.4-.7-.4-.9 0L9 11l-.5-1.1c-.2-.4-.8-.4-1 0zm5.9 3.7l-.7.7-2.4-2.3 2.4-2.4.7.7-1.7 1.7 1.7 1.6zm1 .8l-.7-.7 1.6-1.6-1.6-1.6.7-.7 2.4 2.4-2.4 2.2z"/><circle cx="5.5" cy="7.5" r="1.5';
				break;
			case 'embed-post':
				path = 'M16 4H4c-1.1 0-2 .9-2 2v7c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zM9.1 9.5l-.4.3c-.4.4-.5 1.1-.2 1.6l-.8.8-1.1-1.1-1.3 1.3c-.2.2-1.6 1.3-1.8 1.1s.9-1.6 1.1-1.8l1.3-1.3-1.1-1.1.8-.8c.5.3 1.2.3 1.6-.2l.3-.3c.5-.5.5-1.2.2-1.7l.8-.8 3 2.9-.8.8c-.5-.2-1.2-.2-1.6.3zm4.3 4.1l-.7.7-2.4-2.3 2.4-2.4.7.7-1.7 1.7 1.7 1.6zm1 .8l-.7-.7 1.6-1.6-1.6-1.6.7-.7 2.4 2.4-2.4 2.2z';
				break;
			case 'embed-video':
				path = 'M16 4H4c-1.1 0-2 .9-2 2v7c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zM4 14H3v-1h1v1zm0-2H3v-1h1v1zm0-2H3V9h1v1zm0-2H3V7h1v1zm0-2H3V5h1v1zm3.9 5.1l-.7.7-2.4-2.3 2.4-2.4.7.7-1.7 1.7 1.7 1.6zm1.6 2l-1-.3 2-7 1 .3-2 7zm3.4-1.2l-.7-.7 1.6-1.6L12.2 8l.7-.7 2.4 2.4-2.4 2.2zM17 14h-1v-1h1v1zm0-2h-1v-1h1v1zm0-2h-1V9h1v1zm0-2h-1V7h1v1zm0-2h-1V5h1v1z';
				break;
			case 'excerpt-view':
