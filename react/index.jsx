	...
	render() {
		...
		switch ( icon ) {
			...
			case 'lightbulb':
				...
				break;
			case 'linkedin':
				path = 'M14.5 0h-13C.675 0 0 .675 0 1.5v13c0 .825.675 1.5 1.5 1.5h13c.825 0 1.5-.675 1.5-1.5v-13c0-.825-.675-1.5-1.5-1.5zM6 13H4V6h2v7zM5 5c-.553 0-1-.447-1-1s.447-1 1-1c.553 0 1 .447 1 1s-.447 1-1 1zm8 8h-2V9c0-.553-.447-1-1-1s-1 .447-1 1v4H7V6h2v1.24C9.412 6.676 10.044 6 10.75 6 11.994 6 13 7.12 13 8.5V13z';
				break;
			case 'linkedin2':
				path = 'M6 6h2.767v1.418h.04C9.192 6.728 10.134 6 11.54 6 14.46 6 15 7.818 15 10.183V15h-2.885v-4.27c0-1.018-.02-2.33-1.5-2.33-1.502 0-1.732 1.11-1.732 2.256V15H6V6zM1 6h3v9H1V6zM4 3.5C4 4.328 3.328 5 2.5 5S1 4.328 1 3.5 1.672 2 2.5 2 4 2.672 4 3.5z';
				break;
			case 'list-view':
